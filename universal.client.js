...
var linkify = function (regexObject, anchorCallback, linkifyLinks) {
    if (linkifyLinks === void 0) { linkifyLinks = false; }
...
var generateLinks = function () {
    linkify(/\b((?:https?|s?ftp|scp):\/\/(?!p4)[^\s'"'<>()]*|[-\w.+]+@(?:[-\w]+\.)+[\w]{2,6})\b/ig, function (a, match) {
        var m = match[0];
...
//# sourceMappingURL=universal.client.js.map